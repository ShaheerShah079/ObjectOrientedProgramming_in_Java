...
public class prac_shape3 {
    public static void main(String[] args) {
        ...
        System.out.println("The volume of cylinder is "+cy.volume()+" and area is "+cy.area());

        sphere sp = new  sphere(6);
        System.out.println("The volume of sphere is "+sp.volume()+" and area is "+sp.area());
